...
#'
#' @references Jombart T, Balloux F, Dray S. 2010. adephylo: new tools for investigating the phylogenetic signal in biological traits. Bioinformatics 26: 1907–1909 https://doi.org/10.1093/bioinformatics/btq292
#' @references Paradis E, Claude J, Strimmer K. 2004. APE: Analyses of phylogenetics and evolution in \R language. Bioinformatics 20: 289–290 https://doi.org/10.1093/bioinformatics/btg412
#' @references Revell LJ. 2012. phytools: An \R package for phylogenetic comparative biology (and other things). Methods in Ecology and Evolution 3: 217–223 https://doi.org/10.1111/j.2041-210X.2011.00169.x
#' @references Sidlauskas B. 2008. Continuous and arrested morphological diversification in sister clades of characiform fishes: a phylomorphospace approach. Evolution 62: 3135–3156 https://doi.org/10.1111/j.1558-5646.2008.00519.x
#'
#' @examples

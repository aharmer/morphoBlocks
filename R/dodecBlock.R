...
#' @return \item{raw}{configurations without Procrustes transformation}
#' @return \item{gpa.3D}{configurations after Procrustes transformation organised into a 3D array}
#' @return \item{gpa.2D}{configurations after Procrustes transformation organised into a 2D matrix}
#' @return \item{centroid}{centroid sizes of the configurations}
...
#' @references Schlager S. 2017. Morpho and Rvcg-shape analysis in \R. In Zheng G, Li S, Sz?kely (eds.) Statistical shape and deformation analysis. Academic Press, London. Pp. 217-256.
#' @examples

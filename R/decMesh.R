...
#' @references Wenzel J, Tarini M, Panozzo D, Sorkine-Hormung O. 2015. Instant field-alighed meshes. ACM Transactions on Graphics (Proceedings of SIGGRAPH Asia 2015) 34: 189-181.
#'
#' @examples
#' \dontrun{
...
#' }
#'
#' @importFrom Morpho meshcube pcAlign scalemesh
#' @importFrom Rvcg vcgImport vcgPlyWrite vcgQEdecim vcgUniformRemesh

...
```{r echo = FALSE, loadingsPlot01, fig.align = "center", out.width = "90%"}
...
* Schlager, S. (2017). Morpho and Rvcg – Shape Analysis in R. In G. Zheng, S. Li and G. Székely (Ed.), Statistical shape and deformation analysis (pp. 217-256). Academic Press.

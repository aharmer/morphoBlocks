...
Figure 4. Global component one loadings from a regularised consensus principal component analysis of simulated shape data. See Figure 1 for key.

&nbsp;

![](../man/figures/loadingsPlotExample05.png)
Figure 5. Global component two loadings from a regularised consensus principal component analysis of simulated shape data. See Figure 1 for key.
